                            ...
                            <?php while(have_rows('heros')): ?>
                                ...
                                <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                                    <div class="px-6">
                                        ...
                                        <?php echo wp_get_attachment_image(get_sub_field('image')['ID'], 'thumbnail', false, [
                                            'style' => 'max-width: 120px;',
                                            'class' => 'shadow-lg rounded-full max-w-full mx-auto',
                                        ]); ?>

                                        <div class="pt-6 text-center">
                                            <h5 class="text-xl font-bold"><?php echo get_sub_field('name'); ?></h5>
                                            ...
                                            <div class="mt-6">
                                                <?php if(have_rows('social_media')): ?>
                                                    <?php while(have_rows('social_media')): ?>
                                                        <?php (the_row()); ?>
                                                        <button onClick="window.location='<?php echo get_sub_field('url'); ?>';" target="_blank" class="bg-blue-400 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1">
...
<?php echo $__env->make('layouts.front-page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/asif/www/bedrock/web/app/themes/sage/resources/views/front-page.blade.php ENDPATH**/ ?>