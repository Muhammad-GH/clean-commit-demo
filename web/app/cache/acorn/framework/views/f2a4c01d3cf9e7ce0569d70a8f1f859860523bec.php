        ...
        <div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
            <div class="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
                <a class="text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase text-white"
                    href="https://www.creative-tim.com/learning-lab/tailwind-starter-kit#/presentation"><?php echo get_bloginfo('name'); ?></a>
                <button
...
<?php /**PATH /home/asif/www/bedrock/web/app/themes/sage/resources/views/sections/header.blade.php ENDPATH**/ ?>